  ...
  const accordions = [
    {
      ...
      content: (
        <div className="space-y-3 f-body" style={{ fontSize: "18px", lineHeight: 1.9 }}>
    ...
    },
    {
      ...
      content: (
        <ul className="f-body space-y-2" style={{ fontSize: "18px" }}>
    ...
    },
    {
      ...
      content: (
        <div className="f-body space-y-2" style={{ fontSize: "18px" }}>
            ...
            <div className="border-t border-[#0A0A0A]/[0.08]">
              {accordions.map(({ key, label, content }) => (
                <div key={key} className="border-b border-[#0A0A0A]/[0.08]">
                  ...
                  >
                    <span className="f-label text-[#0A0A0A]" style={{ fontSize: "17px", letterSpacing: "0.1em" }}>
                      {label}
                    </span>
                    <ChevronDown
                      size={14}
