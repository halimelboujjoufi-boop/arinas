    ...
    <footer className="bg-[#0A0A0A] text-white">
      ...
      <div className="max-w-[1680px] mx-auto px-6 lg:px-14 pt-24 pb-16">
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-5">
            ...
            <p className="f-body mt-6 max-w-xs" style={{ color: "rgba(255,255,255,0.4)", lineHeight: 1.8, fontSize: "16px" }}>
              {t("footer.tagline")}
            </p>
          ...
          <div className="lg:col-span-3">
            ...
            {submitted ? (
              <p className="f-label text-[#B89A6A]" style={{ fontSize: "15px", letterSpacing: "0.2em" }}>
                {t("footer.welcome")}
              </p>
            ) : (
      ...
      <div className="border-t border-white/[0.07]">
        <div className="max-w-[1680px] mx-auto px-6 lg:px-14 py-6 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          <p className="f-label text-white/25" style={{ fontSize: "14px", letterSpacing: "0.2em" }}>
