          ...
          <div className="px-7 py-3 bg-[#FAF7F3] border-b border-[#F0EBE3]">
            <div className="flex items-center gap-2 mb-1.5">
              ...
              <p className="text-[11px] text-[#52525B]">
                Add <span className="font-medium text-[#111111]">{(500 - subtotal).toLocaleString()} DH</span> more for free shipping
              </p>
            </div>
        ...
        {state.cart.length > 0 && (
          <div className="border-t border-[#F0EBE3] px-7 py-5 space-y-4 bg-white">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-xs text-[#71717A]">
                <span>Shipping</span>
                <span className={shipping === 0 ? "text-[#C9A86A]" : ""}>{shipping === 0 ? "Free" : `${shipping.toLocaleString()} DH`}</span>
              </div>
